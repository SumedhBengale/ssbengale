...
function App() {
  ...
  return (
    <>
        ...
        <div class=" mx-2 flex">
          <div class="dropdown">
            <label tabindex="0" class="btn m-1 bg-[#4f4f4f] lg:hidden text-white hover:text-black hover:bg-white">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
            </label>
            <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-72">
            <li class="m-2">
                    <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleIntro}>Intro</div>
                    </li>
                    <li class="m-2">
                    <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleSkills}>Skills</div>
                    </li>
                    <li class="m-2">
                    <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleProjects}>Projects</div>
                    </li>
                      <li class="m-2">
                      <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleCertifications}>Certifications</div>
                    </li>
                    <li class="m-2">
                    <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleStats}>Stats</div>
                    </li>
                    <li class="m-2">
                    <div className='btn bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleContact}>Contact Me</div>
                    </li>
            </ul>
          </div>
          ...
          <div class="hidden justify-end lg:flex">
              <ul class="flex">
                ...
                <li class="mr-3">
                <div className='btn btn-ghost bg-[#4f4f4f] text-white hover:text-black hover:bg-white' onClick={handleStats}>Stats</div>
                </li>
                <li class="mr-3">
